...
<div class="max-w-3xl mx-auto lg:mt-40 mt-9">
    ...
    <a type="button" href="{{ route('item.mymarket_index') }}" class="w-full mt-4 text-center bg-red-900 hover:bg-red-800 text-white font-bold py-2 px-4 rounded shadow-lg">Return</a>
</div>
@endsection
