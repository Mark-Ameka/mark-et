    ...
    <div class=" rounded-md p-6">
            ...
            <div class="md:grid md:grid-cols-4 md:space-x-10">
                <div class="mb-4 flex flex-col items-center md:items-start">
                    ...
                    <label for="upload-image" class="
                        ...
                        hover:brightness-50
                    ">
                        <img class="rounded-lg h-40 w-40 object-cover outline-neutral-800" src="{{ asset('items/'.$item->item_image) }}" id="chosen-image">
                    </label>
                ...
                <div class="md:col-span-3">
                    ...
                    <div class="relative">
                        <textarea name="item_description" rows="5" class="resize-none w-full mb-2 pl-10 pr-1 py-2 border outline-none bg-transparent placeholder-neutral-300 text-white border-gray-300 rounded-lg" autocomplete="off" value="{{ $item->item_description }}"></textarea>
                    ...
                    <div class="grid md:grid-cols-2 md:gap-4">
                        <div>
                            ...
                            <div class="relative">
                                <input name="item_qty" type="number" min="1" class="truncate w-full mb-3 pl-10 pr-1 py-2 border outline-none bg-transparent placeholder-neutral-300 text-white border-gray-300 rounded-lg" autocomplete="off" value="{{ $item->item_qty }}">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input name="item_price" type="number" min="1" step="any" step="0.01" class="truncate w-full mb-3 pl-10 pr-1 py-2 border outline-none bg-transparent placeholder-neutral-300 text-white border-gray-300 rounded-lg" autocomplete="off" value="{{ $item->item_price }}">
        ...
        @if ($is_default == false)
            <form method="POST" action="{{ route('item.remove_image', $item->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <button type="submit" class="w-full mt-2 text-center bg-emerald-900 hover:bg-emerald-800 text-white font-bold py-2 px-4 rounded">Remove image</button>
            </form>
        @endif
