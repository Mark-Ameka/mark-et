...
<div class="max-w-lg mx-auto pt-3">
    <div class=" rounded-md p-6">
        <form method="POST" action="{{ route('item.update', $item->id) }}">
            ...
            <div class="relative">
                <textarea name="item_description" rows="5" class="w-full mb-2 pl-10 pr-1 py-2 border outline-none bg-transparent placeholder-neutral-300 text-white border-gray-300 rounded-lg" autocomplete="off" value="{{ $item->item_description }}"></textarea>
            ...
            <div class="grid md:grid-cols-2 md:gap-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input name="item_price" type="number" min="1" class="truncate w-full mb-3 pl-10 pr-1 py-2 border outline-none bg-transparent placeholder-neutral-300 text-white border-gray-300 rounded-lg" autocomplete="off" value="{{ $item->item_price }}">
